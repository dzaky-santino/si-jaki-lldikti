            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('laporan-pts.printToPdf', ['uuid' => $pts->uuid, 'jenis_kegiatan' => request('jenis_kegiatan'), 'filter_year' => request('filter_year'), 'filter_month' => request('filter_month')]) }}"
