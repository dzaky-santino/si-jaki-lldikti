...
@section('title', 'Tambah Perguruan Tinggi Negeri')
...
<div class="section-header">
    <h1>Tambah Perguruan Tinggi Negeri</h1>
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Perguruan Tinggi Negeri</div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header gradient-header">
                    <h4>Form Tambah Perguruan Tinggi Negeri</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
